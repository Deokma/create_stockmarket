...
import by.deokma.create_stockmarket.neoforge.network.RequestShopListPacket;
import by.deokma.create_stockmarket.neoforge.network.RequestTradeStatsPacket;
...
public class StockMarketScreen extends Screen {
    ...
    public StockMarketScreen() {
        super(Component.translatable("screen.create_stockmarket.stock_market"));
    }
